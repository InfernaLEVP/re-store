<template>
  <div class="participants fp-slider lections" id="part">
    <!-- Swiper -->
      <swiper
        :slides-per-view="1"
        :space-between="50"
        ...
        <swiper-slide v-for="slide in slides" :key="slide.Title">
          <div class="participants__item">
            ...
            <div class="participants__bio-wrapper">
              ...
              <h3 class="participants__location">{{slide.SubTitle}}</h3>
