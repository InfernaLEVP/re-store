...
function setBandwidthCap(cap) {
  ...
  document.getElementById("bandwidthCapDropdown").innerHTML =
    "Bandwidth Cap (" + capStr + " Mbps)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
  emitUIInteraction(descriptor);
  console.log(descriptor);
}
...
function setFramerateCap(cap) {
  ...
  capStr = cap != 0 ? cap : "Unlimited";
  document.getElementById("framerateCapDropdown").innerHTML =
    "Framerate Cap (" + capStr + " fps)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
  emitUIInteraction(descriptor);
  console.log(descriptor);
}
...
function myHandleResponseFunction(data) {
  if (data.substring("1080p")) {
    ...
    button4K.title =
      "4K is supported only when -NvEncH264ConfigLevel=NV_ENC_LEVEL_H264_52 UE4 is added to UE4 command line";
  }
}
...
function onFullscreenChange(data) {
  ...
  if (fullscreenImg) {
    fullscreenImg.src = isFullscreen
      ? "images/MinimiseToFullscreen.png"
      : "images/MaximiseToFullscreen.png";
    fullscreenImg.alt = isFullscreen
...
function enterFullscreen() {
  ...
  if(iOS()){
    console.log('ADD FULL IOS');
    document.querySelector('#player').classList.add('iOS-full-screen');
    document.body.classList.add('iOS-full-screen-body');
    document.querySelector('.header').classList.add('iOS-full-screen-header');
    let fullscreenImg = document.getElementById("fullscreen-img");
    fullscreenImg.src = 'images/MinimiseToFullscreen.png';
    isFullscreen = true;
  }else{
    var fullscreenDiv = document.getElementById("player");
...
function exitFullscreen() {
  if(iOS()){
    console.log('REMOVE FULL IOS');
    document.querySelector('#player').classList.remove('iOS-full-screen');
    document.body.classList.remove('iOS-full-screen-body');
    document.querySelector('.header').classList.remove('iOS-full-screen-header');
    let fullscreenImg = document.getElementById("fullscreen-img");
    fullscreenImg.src = 'images/MaximiseToFullscreen.png';
    isFullscreen = false;
  }else{
    var fullscreenDiv = document.getElementById("player");
    var textDivs = document.getElementsByClassName("text");
    ...
    if (!exitFullscreenFunc) {
      ["mozCancelFullScreen", "msExitFullscreen", "webkitExitFullscreen"].forEach(
        function(req) {
    ...
    if (exitFullscreenFunc) {
      ...
      if (headerDiv) headerDiv.style.display = "table";
